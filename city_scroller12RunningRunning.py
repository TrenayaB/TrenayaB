...
class Scroller(object):
    ...
    def add_building(self, x_location):
        ...
        building_width = random.randint((self.width // 15), (self.width // 4))
        ...
        building_height = random.randint((max_height // 5), (max_height - 1))
...
MIDDLE_SCROLLER_COLOR = (30,30,110)
BACK_SCROLLER_COLOR = (50,50,160)
BACKGROUND_COLOR = (17, 19, 89)
